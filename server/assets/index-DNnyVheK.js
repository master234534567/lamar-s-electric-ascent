...
function LamarCursor() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref, className: "lamar-cursor" })
  ] });
}
...
const lamarTunnel = "/assets/lamar-tunnel-XRfyWL7U.png";
...
function Hero() {
  ...
  const [bolt, setBolt] = reactExports.useState(false);
  reactExports.useEffect(() => {
    const onScroll = () => {
      if (window.scrollY > 30 && !bolt) setBolt(true);
    };
...
function Index() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative bg-black text-white", children: [
    ...
    introDone && /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Outro, {})
    ] })
  ] });
}
export {
