...
var gsap$1, _coreInitted$1, _win$1, _doc$1, _docEl$1, _body$1, _isTouch, _pointerType, ScrollTrigger$1, _root$1, _normalizer$1, _eventTypes, _context$1, _getGSAP$1 = function _getGSAP() {
  ...
  preventDefault && !e2._gsapAllow && e2.cancelable !== false && e2.preventDefault();
...
var Observer = /* @__PURE__ */ (function() {
  ...
  _proto.init = function init4(vars) {
    ...
    var id2, onStopDelayedCall, dragged, moved, wheeled, locked, axis, self = this, prevDeltaX = 0, prevDeltaY = 0, passive = vars.passive || !preventDefault && vars.passive !== false, scrollFuncX = _getScrollFunc(target, _horizontal), scrollFuncY = _getScrollFunc(target, _vertical), scrollX = scrollFuncX(), scrollY = scrollFuncY(), limitToTouch = ~type.indexOf("touch") && !~type.indexOf("pointer") && _eventTypes[0] === "pointerdown", isViewport = _isViewport$1(target), ownerDoc = target.ownerDocument || _doc$1, deltaX = [0, 0, 0], deltaY = [0, 0, 0], onClickTime = 0, clickCapture = function clickCapture2() {
      ...
      var x = e2.clientX, y = e2.clientY, dx = x - self.x, dy = y - self.y, isDragging2 = self.isDragging;
      self.x = x;
      self.y = y;
...
var _clampScrollAndGetDurationMultiplier = function _clampScrollAndGetDurationMultiplier2(scrollFunc, current, end, max) {
  ...
  vars.ignoreCheck = function(e2) {
    return _fixIOSBug && e2.type === "touchmove" && ignoreDrag() || scale2 > 1.05 && e2.type !== "touchstart" || self.isGesturing || e2.touches && e2.touches.length > 1;
  };
...
function LamarCursor() {
  const ref2 = reactExports.useRef(null);
  const trailsRef = reactExports.useRef([]);
  reactExports.useEffect(() => {
    const move = (e2) => {
      if (ref2.current) {
        ref2.current.style.left = e2.clientX + "px";
        ref2.current.style.top = e2.clientY + "px";
      }
      trailsRef.current.forEach((t2, i) => {
        setTimeout(() => {
          if (!t2) return;
          t2.style.left = e2.clientX + "px";
          t2.style.top = e2.clientY + "px";
          t2.style.opacity = String(0.4 - i * 0.08);
        }, i * 40);
      });
    };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: ref2, className: "lamar-cursor" })
  ] });
}
...
function PopChild({ children, isPresent, anchorX, anchorY, root, pop }) {
  ...
  reactExports.useInsertionEffect(() => {
    ...
    return () => {
      ref2.current?.removeAttribute("data-motion-pop-id");
...
function NetflixIntro({ onDone }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: show && /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 noise opacity-30" }),
...
function HeroIntroScene({ onComplete }) {
  ...
  reactExports.useEffect(() => {
    ...
    if (rimLightRef.current) {
      ...
      gsapWithCSS.to(rimLightRef.current, {
        opacity: [0.6, 1, 0.6],
        duration: 2,
        repeat: -1,
        ease: "sine.inOut"
    ...
    gsapWithCSS.to(silhouetteRef.current, {
      scrollTrigger: {
        trigger: containerRef.current,
        start: "top top",
        end: "bottom top",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 opacity-40 pointer-events-none", children: [...Array(30)].map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "absolute",
            style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 pointer-events-none", children: [...Array(40)].map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 flex min-h-screen items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ref: rimLightRef,
              ...
              style: {
                background: "radial-gradient(ellipse at 30% 30%, oklch(0.55 0.18 300 / 0.8), oklch(0.25 0.12 300 / 0.2))",
                boxShadow: "0 0 80px var(--ravens-purple-glow), inset 0 0 80px var(--ravens-purple-glow)",
                filter: "blur(20px)"
              }
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              className: "relative",
              style: {
                filter: "drop-shadow(0 0 100px var(--ravens-purple-glow)) contrast(1.3) saturate(1.5)"
              },
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-x-0 bottom-20 z-20 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ref: textRef,
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block", children: "LAMAR" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block", style: { color: "var(--ravens-gold)" }, children: "JACKSON" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block text-2xl", children: "— UNDENIABLE —" })
            ]
          }
        ) }),
...
function CategoryFilter({ onFilter, activeCategory = "ALL" }) {
  const [active, setActive] = reactExports.useState(activeCategory);
  const buttonsRef = reactExports.useRef([]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-4 justify-center mb-12 px-4", children: categories.map((cat, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      ref: (el) => {
      ...
      style: {
        background: active === cat.value ? "linear-gradient(135deg, var(--ravens-purple) 0%, var(--ravens-gold) 100%)" : "transparent",
        color: active === cat.value ? "white" : "var(--ravens-gold)",
        border: `2px solid ${active === cat.value ? "var(--ravens-gold)" : "var(--ravens-purple)"}`,
        boxShadow: active === cat.value ? "0 0 20px var(--ravens-gold), inset 0 0 20px var(--ravens-gold)" : "none",
...
function HighlightCards({ activeCategory = "ALL" }) {
  const containRef = reactExports.useRef(null);
  ...
  const filteredCards = activeCategory === "ALL" ? highlights : highlights.filter((h) => h.category === activeCategory);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ref: containRef,
      ...
      style: {
        background: "radial-gradient(circle at center, oklch(0.15 0.12 300 / 0.4), black 70%)"
      },
      children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/60 uppercase tracking-widest text-xs", children: "Scroll through the moments that defined the legacy" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 lg:grid-cols-3 gap-8", children: filteredCards.map((card, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ref: (el) => {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      children: card.category.replace(/_/g, " ")
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "h3",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/60 text-sm leading-relaxed mb-6", children: card.description })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
...
gsapWithCSS.registerPlugin(ScrollTrigger);
function ThrowPowerScene() {
  const containerRef = reactExports.useRef(null);
  const footballRef = reactExports.useRef(null);
  const textRef = reactExports.useRef(null);
  reactExports.useEffect(() => {
    ...
    gsapWithCSS.to(".football-lace", {
      boxShadow: "0 0 30px var(--ravens-gold), inset 0 0 20px var(--ravens-gold)",
      duration: 0.5,
      stagger: 0.1
    });
    if (textRef.current) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      style: {
        perspective: "1000px",
        background: "radial-gradient(circle at center, oklch(0.25 0.18 300 / 0.4), black 70%)"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 pointer-events-none", children: [...Array(8)].map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 w-full max-w-4xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  style: {
                    ...
                    borderRadius: "50%",
                    position: "relative",
                    boxShadow: "0 0 60px rgba(212, 175, 55, 0.8), inset -10px -10px 30px rgba(0,0,0,0.3)",
                    transformStyle: "preserve-3d"
                  },
                  children: [...Array(3)].map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "h2",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "ARM" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "var(--ravens-gold)" }, children: "TALENT" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl", children: "Undeniable" })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    children: "Precision met with raw power"
                  }
                )
              ]
            }
...
function OutroScene() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: embersRef, className: "absolute inset-0 pointer-events-none", children: [...Array(30)].map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "h1",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "outro-word mb-4", children: "You don't watch" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        ...
                        style: {
                          ...
                          color: "var(--ravens-gold)",
                          textShadow: "0 0 40px var(--ravens-gold), 0 0 80px var(--ravens-purple-glow)"
                        },
                        children: "L A M A R"
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "outro-word", children: "You" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "outro-word mb-2", children: "W I T N E S S" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
...
function JokeEasterEgg() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-black px-6 py-32", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "absolute inset-0",
        style: {
          background: "radial-gradient(circle at center, oklch(0.1 0.04 300), black)"
        }
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "var(--ravens-gold)" }, children: "harder than a rookie cornerback trying to tackle him." })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: "Side effects include: increased confidence, raven pride, inevitable comparisons to other QBs"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
  ...
  reactExports.useEffect(() => {
    ...
    const handleMouseEnter = () => {
      ...
      if (wingsRef.current) {
        ...
        gsapWithCSS.to(wingsRef.current, {
          rotate: [0, -15, 15, 0],
          duration: 2,
          repeat: 2,
          ease: "sine.inOut",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { marginRight: "20px", display: "inline-block" }, children: "🪶" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { marginLeft: "20px", display: "inline-block" }, children: "🪶" })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        style: {
          ...
          fontSize: "32px",
          fontWeight: "900",
          textShadow: "0 0 20px var(--ravens-purple-glow), 0 0 40px var(--ravens-gold)"
        },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "var(--ravens-gold)", marginRight: "8px" }, children: "⚡" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "white" }, children: "GOAT" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "var(--ravens-purple-glow)", fontSize: "20px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "MODE" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "var(--ravens-gold)", marginLeft: "8px" }, children: "⚡" })
        ]
      }
    )
  ] });
    ...
    introDone && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "section",
        {
          ...
          style: {
            background: "radial-gradient(circle at center, oklch(0.15 0.12 300 / 0.3), black 70%)"
          },
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(HighlightCards, { activeCategory }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(SpeedMeterCinematic, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ThrowPowerScene, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(OutroScene, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(JokeEasterEgg, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(GoatModeEasterEgg, { silhouetteElement: silhouetteRef.current })
    ] })
  ] });
}
